  ...
  return (
    <div className="w-full max-w-full">
      <div className="flex items-center justify-between space-x-2">
        <div className="flex-1 h-9 rounded-md border border-muted bg-popover py-2 px-3 max-w-[384px]">
          <Skeleton className="h-4 max-w-[240px] w-full" />
        </div>
        <div className="flex-1 h-9 rounded-md border border-muted bg-popover py-2 px-3 max-w-[116px]">
